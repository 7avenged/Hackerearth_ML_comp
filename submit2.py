...
df = pd.read_csv('criminal_train.csv') #usecols = head12
df2 = pd.read_csv('criminal_test.csv') #usecols = head12
...
df3 = pd.DataFrame({"PERID" : df2.PERID, "Criminal" :c1})

df3.to_csv("output1.csv", index=False)
